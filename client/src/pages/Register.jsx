...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-900 min-w-sm text-white ">
      <Link
        to="/"
      ...
      <div className="bg-gray-800 py-8 px-4 mt-6 rounded-lg shadow-md w-sm md:w-[80%] lg:w-[60%]">
        ...
        <form
          ...
          className="flex flex-row flex-wrap gap-3 justify-center md:justify-start bg-gray-800 "
        >
              ...
              >
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 rounded-md border-2 outline-none ${
                    inputData?.valid ? "border-gray-500" : "border-red-400"
                  }`}
                  required
                />
                {index === 3 && (
                ...
                {index !== 3 && !inputData.valid && (
                  <p className="text-red-400 font-semibold text-sm py-0.5 px-2 rounded-xl w-fit">
